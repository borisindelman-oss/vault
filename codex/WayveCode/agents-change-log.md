...
- Changes:
  - [[2026/02/Week-2/2026-02-10-model-info-finder-skill-script-extraction]]: added helper + per-workflow `.sh` entrypoints, renamed helper to `model_catalogue_helpers.sh` for clearer discoverability, rewrote `SKILL.md` to use script calls instead of inlined command blocks, and added explicit missing dependency/token prompts plus script-evolution guidance.
